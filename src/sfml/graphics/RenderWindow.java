...
import sfml.internal.UnsafeOperations;
...
public class RenderWindow extends Window implements RenderTarget {
     ...
     *
     * @see RenderWindow#create(sfml.window.VideoMode, String, int, sfml.window.ContextSettings)
     */
    public RenderWindow() {
        super();
    }
     ...
     * @see #create(sfml.window.VideoMode, String, int, sfml.window.ContextSettings)
     */
     ...
     * @param title the window title.
     * @param style the window style.
     * @see #create(sfml.window.VideoMode, String, int)
     */
     ...
     * resulting image as a texture. For that, use {@link Texture#update(sfml.window.Window)}
