...
import sfml.internal.IntercomHelper;
import sfml.internal.JSFMLError;
import sfml.internal.SFMLNative;
import sfml.internal.SFMLNativeObject;
...
public class Window extends SFMLNativeObject implements WindowStyle {
     ...
     *
     * @see Window#create(sfml.window.VideoMode, String, int, sfml.window.ContextSettings)
     */
    public Window() {
        super();
     ...
     * @see sfml.window.VideoMode#isValid()
     * @see WindowStyle
     * @see ContextSettings
     */
     ...
     * listen to an event of type {@link sfml.window.event.Event.Type#CLOSED} and use
     ...
     * @see sfml.window.event.JoystickMoveEvent
     */
