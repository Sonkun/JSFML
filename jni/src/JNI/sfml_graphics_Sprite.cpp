#include <JSFML/JNI/sfml_graphics_Sprite.h>
...
/*
 * Class:     sfml_graphics_Sprite
 * Method:    nativeCreate
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Sprite_nativeCreate (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Sprite_nativeSetExPtr (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Sprite_nativeDelete (JNIEnv *env, jobject obj) {
 ...
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Sprite_nativeSetTexture
 ...
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Sprite_nativeSetTextureRect (JNIEnv *env, jobject obj, jobject rect) {
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Sprite_nativeSetColor (JNIEnv *env, jobject obj, jint color) {
 ...
 * Signature: (Ljava/nio/Buffer;)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Sprite_nativeGetLocalBounds (JNIEnv *env, jobject obj, jobject r) {
 ...
 * Signature: (Ljava/nio/Buffer;)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Sprite_nativeGetGlobalBounds (JNIEnv *env, jobject obj, jobject r) {
