#include <JSFML/JNI/sfml_graphics_ConvexShape.h>
...
/*
 * Class:     sfml_graphics_ConvexShape
 * Method:    nativeCreate
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_ConvexShape_nativeCreate (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_ConvexShape_nativeSetExPtr (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_ConvexShape_nativeDelete (JNIEnv *env, jobject obj) {
 ...
 * Signature: (IFF)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_ConvexShape_nativeSetPoint
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_ConvexShape_nativeSetPointCount
