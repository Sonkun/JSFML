#include <JSFML/JNI/sfml_graphics_Text.h>
...
/*
 * Class:     sfml_graphics_Text
 * Method:    nativeCreate
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Text_nativeCreate (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Text_nativeSetExPtr (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Text_nativeDelete (JNIEnv *env, jobject obj) {
    delete THIS(sf::Text);
}
 ...
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Text_nativeSetString
 ...
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Text_nativeSetFont
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Text_nativeSetCharacterSize
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Text_nativeSetStyle
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Text_nativeSetColor (JNIEnv *env, jobject obj, jint color) {
 ...
 * Signature: (I)J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Text_nativeFindCharacterPos (JNIEnv *env, jobject obj, jint pos) {
 ...
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Text_nativeGetLocalBounds (JNIEnv *env, jobject obj, jobject r) {
 ...
 * Signature: (Ljava/nio/Buffer;)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Text_nativeGetGlobalBounds (JNIEnv *env, jobject obj, jobject r) {
