#include <JSFML/JNI/sfml_window_Window.h>
...
#define SF_WINDOW JSFML::NativeObject::GetExPointer<sf::Window>(env, obj, sfml_internal_ExPtr_WINDOW)

/*
 * Class:     sfml_window_Window
 * Method:    nativeCreate
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_window_Window_nativeCreate (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativeSetExPtr (JNIEnv *env, jobject obj) {
    JSFML::NativeObject::SetExPointer(env, obj, sfml_internal_ExPtr_WINDOW, THIS(sf::Window));
}
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativeDelete (JNIEnv *env, jobject obj) {
 ...
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativeCreateWindow
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_sfml_window_Window_isLegalWindowThread (JNIEnv *env, jclass cls) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_close (JNIEnv *env, jobject obj) {
    SF_WINDOW->close();
}
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_sfml_window_Window_isOpen (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_window_Window_nativeGetPosition (JNIEnv *env, jobject obj) {
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativeSetPosition
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_window_Window_nativeGetSize (JNIEnv *env, jobject obj) {
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativeSetSize
    (JNIEnv *env, jobject obj, jint x, jint y) {
 ...
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativeGetSettings (JNIEnv *env, jobject obj, jobject buf) {
 ...
 * Signature: (Ljava/nio/Buffer;)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativePollEvent (JNIEnv *env, jobject obj, jobject buffer) {
 ...
 * Signature: (Ljava/nio/Buffer;)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativeWaitEvent (JNIEnv *env, jobject obj, jobject buffer) {
    jint *data = (jint*)env->GetDirectBufferAddress(buffer);
    sf::Event event;
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_setVerticalSyncEnabled (JNIEnv *env, jobject obj, jboolean b) {
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_setMouseCursorVisible (JNIEnv *env, jobject obj, jboolean b) {
 ...
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativeSetTitle (JNIEnv *env, jobject obj, jstring title) {
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_setVisible (JNIEnv *env, jobject obj, jboolean b) {
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_setKeyRepeatEnabled (JNIEnv *env, jobject obj, jboolean b) {
 ...
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_nativeSetIcon
 ...
 * Signature: (Z)Z
 */
JNIEXPORT jboolean JNICALL Java_sfml_window_Window_nativeSetActive
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_display (JNIEnv *env, jobject obj) {
    SF_WINDOW->display();
}
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_setFramerateLimit (JNIEnv *env, jobject obj, jint fps) {
 ...
 * Signature: (F)V
 */
JNIEXPORT void JNICALL Java_sfml_window_Window_setJoystickTreshold (JNIEnv *env, jobject obj, jfloat t) {
