#include <string.h>
#include <JSFML/JNI/sfml_audio_SoundBuffer.h>
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_audio_SoundBuffer_nativeCreate (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_audio_SoundBuffer_nativeDelete (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_audio_SoundBuffer_nativeCopy (JNIEnv *env, jobject obj) {
 ...
 */
JNIEXPORT jboolean JNICALL Java_sfml_audio_SoundBuffer_nativeLoadFromSamples
 ...
 */
JNIEXPORT void JNICALL Java_sfml_audio_SoundBuffer_nativeGetData
