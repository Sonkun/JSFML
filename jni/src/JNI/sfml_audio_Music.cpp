#include <JSFML/JNI/sfml_audio_Music.h>
...
/*
 * Class:     sfml_audio_Music
 * Method:    nativeCreate
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_audio_Music_nativeCreate (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_audio_Music_nativeSetExPtr (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_audio_Music_nativeDelete (JNIEnv *env, jobject obj) {
 ...
 */
JNIEXPORT jboolean JNICALL Java_sfml_audio_Music_nativeOpenFromStream
 ...
 */
JNIEXPORT void JNICALL Java_sfml_audio_Music_nativeGetData
