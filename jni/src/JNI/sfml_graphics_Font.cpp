#include <JSFML/JNI/sfml_graphics_Font.h>
...
/*
 * Class:     sfml_graphics_Font
 * Method:    nativeDelete
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Font_nativeDelete (JNIEnv *env, jobject obj) {
    delete THIS(sf::Font);
}
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Font_nativeCreate (JNIEnv *env, jobject obj) {
 ...
 * Signature: ([B)J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Font_nativeLoadFromMemory
 ...
 * Signature: ([BJ)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Font_nativeReleaseMemory
 ...
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Font_nativeGetGlyph
 ...
 * Signature: (III)I
 */
JNIEXPORT jint JNICALL Java_sfml_graphics_Font_nativeGetKerning
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_sfml_graphics_Font_nativeGetLineSpacing
 ...
 * Signature: (I)J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Font_nativeGetTexture
    (JNIEnv *env, jobject obj, jint size) {
