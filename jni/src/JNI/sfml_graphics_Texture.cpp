#include <JSFML/JNI/sfml_graphics_Texture.h>
...
/*
 * Class:     sfml_graphics_Texture
 * Method:    nativeGetMaximumSize
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_sfml_graphics_Texture_nativeGetMaximumSize (JNIEnv *env, jclass cls) {
 ...
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Texture_nativeBind
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Texture_nativeCreate__ (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Texture_nativeDelete (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Texture_nativeCopy (JNIEnv *env, jobject obj) {
 ...
 * Signature: (II)Z
 */
JNIEXPORT jboolean JNICALL Java_sfml_graphics_Texture_nativeCreate__II
 ...
 */
JNIEXPORT jboolean JNICALL Java_sfml_graphics_Texture_nativeLoadFromStream
 ...
 */
JNIEXPORT jboolean JNICALL Java_sfml_graphics_Texture_nativeLoadFromFile
 ...
 */
JNIEXPORT jboolean JNICALL Java_sfml_graphics_Texture_nativeLoadFromImage
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Texture_nativeGetSize (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Texture_nativeCopyToImage (JNIEnv *env, jobject obj) {
  ...
  */
JNIEXPORT void JNICALL Java_sfml_graphics_Texture_nativeUpdate__Lsfml_graphics_Image_2II
 ...
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Texture_nativeUpdate__Lsfml_window_Window_2II
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_sfml_graphics_Texture_nativeIsSmooth
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Texture_nativeSetSmooth (JNIEnv *env, jobject obj, jboolean b) {
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_sfml_graphics_Texture_nativeIsRepeated
    (JNIEnv *env, jobject obj) {
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Texture_nativeSetRepeated (JNIEnv *env, jobject obj, jboolean b) {
