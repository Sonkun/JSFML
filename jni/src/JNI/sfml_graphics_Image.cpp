#include <JSFML/JNI/sfml_graphics_Image.h>
...
/*
 * Class:     sfml_graphics_Image
 * Method:    nativeCreate
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Image_nativeCreate (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Image_nativeDelete (JNIEnv *env, jobject obj) {
 ...
 * Signature: ([B)Z
 */
JNIEXPORT jboolean JNICALL Java_sfml_graphics_Image_nativeLoadFromMemory (JNIEnv *env, jobject obj, jbyteArray arr) {
 ...
 */
JNIEXPORT jboolean JNICALL Java_sfml_graphics_Image_nativeSaveToFile (JNIEnv *env, jobject obj, jstring fileName) {
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_sfml_graphics_Image_nativeGetSize
 ...
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Image_nativeSync
 ...
 * Signature: (IILjava/nio/Buffer;)V
 */
JNIEXPORT void JNICALL Java_sfml_graphics_Image_nativeCommit
    (JNIEnv *env, jobject obj, jint width, jint height, jobject buffer) {
