#include <JSFML/JNI/sfml_internal_SFMLNative.h>
...
/*
 * Class:     sfml_internal_SFMLNative
 * Method:    nativeInit
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_sfml_internal_SFMLNative_nativeInit (JNIEnv *env, jclass cls) {
    JVM::Init(env);
