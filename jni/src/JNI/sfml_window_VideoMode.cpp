#include <JSFML/JNI/sfml_window_VideoMode.h>

#include <SFML/Window/VideoMode.hpp>

/*
 * Class:     sfml_window_VideoMode
 * Method:    nativeGetDesktopMode
 * Signature: (Ljava/nio/Buffer;)V
 */
JNIEXPORT void JNICALL Java_sfml_window_VideoMode_nativeGetDesktopMode
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_sfml_window_VideoMode_nativeGetFullscreenModeCount
 ...
 * Signature: (Ljava/nio/Buffer;)V
 */
JNIEXPORT void JNICALL Java_sfml_window_VideoMode_nativeGetFullscreenModes
    (JNIEnv *env, jclass cls, jobject buf) {
